...
{
    public partial class EncryptMigrationion_Step6_EncryptBackupDataIntoOriginalColumns : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                OPEN SYMMETRIC KEY AW_ColumnKey DECRYPTION BY CERTIFICATE AW_tdeCert; 
                UPDATE [HumanResources].[Employee] 
                    ...
                    ,[HireDate] = encryptByKey(Key_GUID('AW_ColumnKey'), CONVERT(varbinary(max), [HireDateBackup])) CLOSE ALL SYMMETRIC KEYS;
            ");
        }
